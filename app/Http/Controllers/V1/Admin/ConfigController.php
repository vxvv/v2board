...
class ConfigController extends Controller
{
    ...
    {
        $botToken = config('v2board.telegram_bot_token', $request->input('telegram_bot_token'));
        $hookUrl = secure_url('/api/v1/guest/telegram/webhook?access_token=' . hash_hmac('sha256', $botToken, config('app.key')));
